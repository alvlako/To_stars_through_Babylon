...
define labashi_talks = Character("Labashi")
image Labashi = "Labashi.png" # change later
...
label tavern:
    ...
    menu:
        "Politely decline":
            shibtu_talks "O, my lady, I have no words to give you my gratitude. Indeed, I am not happy in the house of the man that my mother went to. But, my lady, I beg your forgiveness. I came out of this house today to never come back. I am planning on going to Esagila temple. "
            jump astronomer_path

        "Agree":
            shibtu_talks "O, my lady, I have no words to give you my gratitude. Indeed, I am not happy in the house of the man that my mother went to. I must not hide from you, I thought about taking my father’s position but I should understand that it is something no girl ever did. "
            shibtu_talks "I see that indeed I should be wise and take the way of the priestess instead of losing my spirit on stupid fights."

            jump astronomer_path #priestess_path

    #   return

label astronomer_path:

    scene tavern_interior
    show Shibtu at left
    show Ahatabisha at right


    ahatabisha_talks "Brave heart, taking no distraction on the way of the sharp mind. Do you understand, Shibtu, that it would be very hard for you, six times sixty harder than for any boy, son of the astronomer? "
    ahatabisha_talks "Since the beginning of my service, since the beginning of my apprenticeship at Ishtar temple 15 years ago, I have never heard about a girl who became an astronomer." 
    shibtu_talks "My lady, would you say it is absolutely impossible for a woman?" 
    ahatabisha_talks "I can not say this, Shibtu. Only gods know what is possible, what is not, and what actually is going to happen. I am only a humble servant of Ishtar, who sometimes receives her messages. "
    shibtu_talks "Then, my lady, I shall try. I shall try, otherwise my entire life I would mourn the dream of observing the stars, of computing the most beautiful predictions, of seeing the omens that celestial bodies send."
    ahatabisha_talks "Here you said well, Shibtu. You are smart and you are brave. Who knows, maybe you would be the first of the girls-astronomers. I will help you. "
    ahatabisha_talks "I know very well the highest priest-astronomer of Esagila temple. Let me talk to him first. And do not worry, shall your mission not succeed, my offer remains for you."
    shibtu_talks "My lady, I appreciate your enormous help! Let gods send you the best of their gifts. I have nothing to pay for your kindness, but if I become an astronomer, you shall not worry about your older years. I will take care of you. "
    ahatabisha_talks "No need, Shibtu, to pay me back. Let me talk to him first. And let me tell you something very important, and remember this very well. You shall be very, very careful with the name of your father. I noticed, you did not want to tell me his name first, you are a wise girl. "
    ahatabisha_talks "But if the temple astronomer, the high priest Labashi would let us come, do not tell anyone about your father, unless the high priest asks you himself. "
    ahatabisha_talks "Come to the gate of the House of Ishtar on the day after the following day, after the morning watch. My servant will meet you and guide to my chamber."

label Labashi_chamber:

    scene labashi_chamber #change later, authors rights
    show Ahatabisha at left with moveinleft
    show Labashi at right

    ahatabisha_talks "Good day, my beautiful lord Labashi!"
    labashi_talks "Ahat-abisha! I am so blessed today by seeing your most beloved face, and your refreshing smile. Seven days I have not seen you - what a cruel time they were!"
    ahatabisha_talks "The wish of my heart, Labashi, you know, parting is hard for me as well. How often I think about you in front of the sacrificial altar - I hope Inanna takes my thoughts together with the animals to prolong your life and to save us from sorrows." 
    labashi_talks "My beloved lady Ahat-abisha, thank you for your tender reminder. Indeed, we have duties. Are they not a part of who we are? Do I not love the powerful lady who sends her omens to the king?"
    labashi_talks "But I love also the Ahat-abisha who takes off her insignias. But let me not bother you with my silly adorations. Looking at your face, I feel you have come to say something."
    ahatabisha_talks "Indeed my love, whom I love both at the culmination of his service, at his computations and in front of the crowd, and here, at the quiet fireplace. "
    ahatabisha_talks "I have come to you to talk about a person who wants to take the position of astronomer. The position was held before by the father of the person. "
    labashi_talks "Ahat-abisha, why would you come to talk about this? You should know well, there is a very routine path to achieve this. The son of the temple astronomer has a right to claim the position. "
    labashi_talks "Upon the successful examination in front of the priests' jury, he must receive back his father’s post as well as material provisions. "
    ahatabisha_talks "Labashi, the issue here is that this person is not a son."
    labashi_talks "Who then? Brother?" 
    ahatabisha_talks "This person is no man. She is a girl, Shibtu, daughter of Bel-aba-usur."
